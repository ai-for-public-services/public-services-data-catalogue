...
This page catalogues database sources and datasets that relate to UK public services offered by central government available under a [Open Government Licence](https://en.wikipedia.org/wiki/Open_Government_Licence). They may be useful for analysing trends in the use of central government services and conducting analyses to assess the use and potential of automated decision-making and AI applications in service delivery. 
